...
const PaymentBodyCmp = ({ nft, nftCurrency }) => (
  <div className="flex flex-col">
    ...
    <div className="flexBetween mt-10">
      <p className="font-poppins dark:text-white font-normal text-nft-black-1  text-base minlg:text-xl">
        Total
      </p>
      <p className="font-poppins dark:text-white font-normal text-nft-black-1  text-sm minlg:text-xl">
        {nft.price} <span className="font-semibold">{nftCurrency}</span>
      </p>
    </div>
  </div>
